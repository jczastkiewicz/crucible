...
**In progress.** 87 of the corpus's 203 script-driven `Effect` APIs resolve (`Draw`, `DealDamage`, `GainLife`, `Pump`,
...
`Balance`, `AddPhase`, `SkipPhase`) — see `docs/crucible/porting/port-log/game-state.md` for the per-API landing notes;
