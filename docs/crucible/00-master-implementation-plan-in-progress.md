...
**In progress.** 47 of the corpus's 203 script-driven `Effect` APIs resolve (`Draw`, `DealDamage`, `GainLife`, `Pump`,
...
`ChoosePlayer`, `ChooseColor`, `ChooseNumber`, `Reveal`, `PeekAndReveal`, `TapOrUntap`, `Proliferate`) — see
