...
// TestActivationShape covers Tap, SelfSac, SelfExile, SelfReturn, SelfExert,
// Discard, PayLife, PayEnergy, tapXType and Return<N/Type> both alone and
...
func TestActivationShape(t *testing.T) {
	...
	cases := []struct {
		...
		{"Exert<1/CARDNAME>", cost.ActivationShape{SelfExert: true}, true},
		{"Exert<1/NICKNAME>", cost.ActivationShape{SelfExert: true}, true},
		{"T Exert<1/CARDNAME>", cost.ActivationShape{Tap: true, SelfExert: true}, true},
		{"1 W T Exert<1/CARDNAME>", cost.ActivationShape{Tap: true, SelfExert: true}, true},
		{"Exert<2/CARDNAME>", cost.ActivationShape{}, false},
		{"Exert<1/Creature.Other/another creature>", cost.ActivationShape{}, false},
		{"Exert<1/CARDNAME> Exert<1/CARDNAME>", cost.ActivationShape{}, false},
		{"AddCounter<1/LOYALTY>", cost.ActivationShape{AddCounterN: 1, AddCounterType: "LOYALTY"}, true},
		{"AddCounter<0/LOYALTY>", cost.ActivationShape{AddCounterN: 0, AddCounterType: "LOYALTY"}, true},
		{"AddCounter<2/LOYALTY>", cost.ActivationShape{AddCounterN: 2, AddCounterType: "LOYALTY"}, true},
		{"AddCounter<1/LOYALTY/CARDNAME>", cost.ActivationShape{AddCounterN: 1, AddCounterType: "LOYALTY"}, true},
		{"AddCounter<1/LOYALTY/NICKNAME>", cost.ActivationShape{AddCounterN: 1, AddCounterType: "LOYALTY"}, true},
		{"T AddCounter<1/LOYALTY>", cost.ActivationShape{Tap: true, AddCounterN: 1, AddCounterType: "LOYALTY"}, true},
		{"AddCounter<1/LOYALTY> PayLife<1>",
			cost.ActivationShape{AddCounterN: 1, AddCounterType: "LOYALTY", PayLifeN: 1}, true},
		{"SubCounter<1/LOYALTY>", cost.ActivationShape{SubCounterN: 1, SubCounterType: "LOYALTY"}, true},
		{"SubCounter<0/LOYALTY>", cost.ActivationShape{SubCounterN: 0, SubCounterType: "LOYALTY"}, true},
		{"SubCounter<3/P1P1>", cost.ActivationShape{SubCounterN: 3, SubCounterType: "P1P1"}, true},
		{"SubCounter<1/DREAM/NICKNAME>", cost.ActivationShape{SubCounterN: 1, SubCounterType: "DREAM"}, true},
		{"T SubCounter<1/CHARGE>", cost.ActivationShape{Tap: true, SubCounterN: 1, SubCounterType: "CHARGE"}, true},
		{"AddCounter<1/LOYALTY> SubCounter<1/LOYALTY>",
			cost.ActivationShape{AddCounterN: 1, AddCounterType: "LOYALTY", SubCounterN: 1, SubCounterType: "LOYALTY"},
			true},
		{"AddCounter<X/LOYALTY>", cost.ActivationShape{}, false},
		{"AddCounter<-1/LOYALTY>", cost.ActivationShape{}, false},
		{"AddCounter<1/LOYALTY/Creature.YouCtrl/a creature you control>", cost.ActivationShape{}, false},
		{"AddCounter<1/LOYALTY> AddCounter<1/LOYALTY>", cost.ActivationShape{}, false},
		{"SubCounter<X/LOYALTY>", cost.ActivationShape{}, false},
		{"SubCounter<-1/LOYALTY>", cost.ActivationShape{}, false},
		{"SubCounter<1/LOYALTY/Planeswalker.YouCtrl/Planeswalker you Control>", cost.ActivationShape{}, false},
		{"SubCounter<1/LOYALTY> SubCounter<1/LOYALTY>", cost.ActivationShape{}, false},
		{"ExileFromGrave<1/CARDNAME>", cost.ActivationShape{SelfExileFromGrave: true}, true},
		{"ExileFromGrave<1/NICKNAME>", cost.ActivationShape{SelfExileFromGrave: true}, true},
		{"1 B ExileFromGrave<1/CARDNAME>", cost.ActivationShape{SelfExileFromGrave: true}, true},
		{"ExileFromGrave<1/CARDNAME> PayLife<1>",
			cost.ActivationShape{SelfExileFromGrave: true, PayLifeN: 1}, true},
		{"ExileFromGrave<2/CARDNAME>", cost.ActivationShape{}, false},
		{"ExileFromGrave<1/Creature.Other/another creature>", cost.ActivationShape{}, false},
		{"ExileFromGrave<1/CARDNAME> ExileFromGrave<1/CARDNAME>", cost.ActivationShape{}, false},
		...
		{"Discard<1/CARDNAME>", cost.ActivationShape{SelfDiscard: true}, true},
		{"Discard<1/NICKNAME>", cost.ActivationShape{SelfDiscard: true}, true},
		{"2 G Discard<1/CARDNAME>", cost.ActivationShape{SelfDiscard: true}, true},
		{"Discard<1/CARDNAME> Discard<1/CARDNAME>", cost.ActivationShape{}, false},
		{"Discard<2/CARDNAME>", cost.ActivationShape{}, false},
		{"ExileFromHand<1/CARDNAME>", cost.ActivationShape{SelfExileFromHand: true}, true},
		{"ExileFromHand<1/NICKNAME>", cost.ActivationShape{SelfExileFromHand: true}, true},
		{"1 R ExileFromHand<1/CARDNAME>", cost.ActivationShape{SelfExileFromHand: true}, true},
		{"ExileFromHand<2/CARDNAME>", cost.ActivationShape{}, false},
		{"ExileFromHand<1/Card.Red+Other/red card>", cost.ActivationShape{}, false},
		{"ExileFromHand<1/CARDNAME> ExileFromHand<1/CARDNAME>", cost.ActivationShape{}, false},
