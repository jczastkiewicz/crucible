...
**In progress.** 137 of the corpus's 203 script-driven `Effect` APIs resolve (`Draw`, `DealDamage`, `GainLife`, `Pump`,
...
`ManifestDread`, `SetState`, `Goad`, `RemoveFromMatch`, `ActivateAbility`, `MultiplePiles`, `DamageResolve`) — see
