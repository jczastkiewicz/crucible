...
| [`internal/engine`](../../../crucible/internal/engine)                 | The rules core: the arena every handle indexes into, cards and their parts, players, zones, effect dispatch, the controller interface, state-based actions, turn structure, mulligans, the stack | `forge.game.Game`, `Card`, `Player`, `zone.Zone`, `zone.ZoneType`, `zone.MagicStack`, `player.PlayerController`, `GameAction`, `phase.PhaseHandler`, `mulligan.*` | [`game-state.md`](../porting/port-log/game-state.md)                 |
