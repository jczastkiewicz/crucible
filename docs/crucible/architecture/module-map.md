...
| [`internal/fixture`](../../../crucible/internal/fixture)               | Forge's `GameState` text format: parses it, builds a `*engine.Game` from it, and writes one back                                                                                      | `forge.game.GameState` (`parse`, `processCardsForZone`, `applyGameOnThread`, `toString`)                                                       | [`game-state-fixture.md`](../porting/port-log/game-state-fixture.md) |
