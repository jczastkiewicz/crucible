...
| [`internal/engine`](../../../crucible/internal/engine)                 | The rules core: the arena every handle indexes into, cards and their parts, players, zones, effect dispatch                     | `forge.game.Game`, `Card`, `Player`, `zone.Zone`, `zone.ZoneType`                       | —                                                                  |
...
| [`tools/vocabscan`](../../../crucible/tools/vocabscan)                 | Prints that vocabulary, by kind or by frequency, so M3's job is enumerated rather than estimated                                | — new code                                                                              | —                                                                  |
...
**Twenty-three packages: two in `pkg/`, eleven in `internal/`, one `cmd/`, nine in `tools/`.** The split follows
