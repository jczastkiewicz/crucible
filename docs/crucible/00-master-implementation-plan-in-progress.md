...
**In progress.** 156 of the corpus's 203 script-driven `Effect` APIs resolve (`Draw`, `DealDamage`, `GainLife`, `Pump`,
...
`BecomeMonarch`, `TakeInitiative`, `Venture`) — see `docs/crucible/porting/port-log/game-state.md` for the per-API
