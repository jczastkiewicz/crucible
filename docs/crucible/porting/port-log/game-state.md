...
`APlayerHasMoreLifeThanEachOther$`/`APlayerHasMostCardsInHand$` (3 real lines or fewer each --
`Trigger.requirementsCheck`'s own whole-table comparisons, a third general gate distinct from both
