...
| Shape                                                                           | Lines | Blocker                                                                                                                                                                                                                                                          |
| ------------------------------------------------------------------------------- | ----- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `K:ETBReplacement:Copy:<SVar>[:Optional]` ("enters as a copy", Clone itself)    | 62    | Three missing pieces: the engine expands no `ETBReplacement` keyword (405 corpus lines, every mode); `compile` does not compile the SVar it names; and no hook runs an ability on the entering card before it lands, with `Choices$` over last battlefield state |
