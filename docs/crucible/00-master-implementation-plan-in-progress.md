...
**In progress.** 139 of the corpus's 203 script-driven `Effect` APIs resolve (`Draw`, `DealDamage`, `GainLife`, `Pump`,
...
`ChooseSource`, `Empower`) — see `docs/crucible/porting/port-log/game-state.md` for the per-API landing notes; items
