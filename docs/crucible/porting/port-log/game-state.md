...
`resolveAmount`/`subAbilityConditionMet` already followed for their own Java counterparts. The legend rule's own
remaining Partner-non-legendary-name corner case is item 25's other named gap and is unrelated to LKI at all -- it needs
a card-name lookup this port's `carddb`/`compile` layer has no equivalent of, and injecting one into the engine would
violate GO-2 (`## The legend rule needed CheckStateBasedActions to take a controller`, above).
...
| CR 616's own general "more than one replacement effect could apply, the affected player chooses" ordering procedure — needs a `PlayerController` hook this port does not have; moot for four resolved shapes' own idempotent outcome (`Tapped = true`, blocked, prevented) but real for `drawReplaced`'s/`gainLifeReplaced`'s own non-idempotent ones (no real corpus deck combines two Draw- or GainLife-replacing permanents today, so not yet observable). Most `Event$` values past `Moved`/`Untap`/`DamageDone`/`Draw`/`GainLife` (`Counter`, `AddCounter`, `CreateToken`, `BeginPhase`, `GameLoss`, `ProduceMana`, ...), `Draw`'s own remaining 33 real `ReplaceWith$` lines and `GainLife`'s own remaining 16, stay unresolved too (`## Replacement effects`, `## ReplacementEffect.requirementsCheck lands`, above)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | M5-M6 |
