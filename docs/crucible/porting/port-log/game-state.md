...
| A qualified Hexproof (`Hexproof from red`, `Hexproof:Artifact`, roughly 30 of 110 real lines) still does not prevent an Aura from enchanting its host (`hostRefusesEnchant`, staticability.go, only resolves bare Hexproof's own unconditional "any opponent" form and Protection's both real shapes) — needs its own `ValidSource$`/`ValidSA$` evaluation, the same gap `compareMatches` (valid.go) already has for a qualified Compare property elsewhere                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        | M5-M6 |
