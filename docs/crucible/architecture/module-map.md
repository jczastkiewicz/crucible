...
| [`internal/engine`](../../../crucible/internal/engine)                 | The rules core: the arena every handle indexes into, cards and their parts, players and zones                                   | `forge.game.Game`, `Card`, `Player`, `zone.Zone`, `zone.ZoneType`                       | —                                                                  |
...
**Twenty-two packages: two in `pkg/`, eleven in `internal/`, one `cmd/`, eight in `tools/`.** The split follows
