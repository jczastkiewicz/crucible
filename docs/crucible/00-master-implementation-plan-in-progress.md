...
**In progress.** 145 of the corpus's 203 script-driven `Effect` APIs resolve (`Draw`, `DealDamage`, `GainLife`, `Pump`,
...
`ChooseSource`, `Empower`, `Earthbend`, `Airbend`, `Discover`, `Draft`, `Heist`, `ExchangeZone`) — see
