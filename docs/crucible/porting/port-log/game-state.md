...
Java's extra-turn stack is modeled (`nextActivePlayer`/`addExtraTurn`, `turn.go`, fed by `AddTurn` and `SkipTurn`). Not
modeled, and each is a real rule some card will eventually need: the extra-phase stack (`AddPhase`, `SkipPhase` —
neither ability is implemented, so nothing can push onto it), topsy-turvy phase order (a handful of effects reverse it),
and CR 502.3's "this permanent doesn't untap" effects.
...
`nCombatsThisTurn==1` -- always true here: this port has no extra-combat mechanism (`AddPhase` is not built, and
`turn.go`'s own doc comment says extra phases are not ported), so no real game this port can play ever reaches a second
...
chain link (`DB$ Effect`, `DB$ DelayedTrigger`, neither built --
...
- `Cleanup`'s `ClearChosenType$`/`ClearNamedCard$`. They clear values nothing in this port sets yet (`ChooseType`/
  `NameCard` not ported); a silent no-op would go stale the day those land.
...
| Interactive priority (`mainLoopStep`'s real APNAP pass), extra phases, topsy-turvy phase order — `ResolveStack` plays out only the degenerate case, nobody able to respond ("doesn't untap" effects are no longer a gap here: `untapBlocked`, `## Replacement effects`, above)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | M5-M6 |
