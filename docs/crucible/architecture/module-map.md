...
| [`internal/engine`](../../../crucible/internal/engine)                 | The rules core: the arena every handle indexes into, cards, players and zones                                                   | `forge.game.Game`, `Card`, `Player`, `zone.Zone`, `zone.ZoneType`                       | —                                                                  |
