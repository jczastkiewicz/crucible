...
The pull request runs the same checks as any other. Eight of them can be broken by upstream:
...
2. Check the eight gates above. Green means the port is unaffected and the PR can merge.
