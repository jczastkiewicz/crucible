...
| [`internal/engine`](../../../crucible/internal/engine)                 | The rules core: the arena every handle indexes into, cards and their parts, players, zones, effect dispatch, the controller interface | `forge.game.Game`, `Card`, `Player`, `zone.Zone`, `zone.ZoneType`, `player.PlayerController` | [`game-state.md`](../porting/port-log/game-state.md)                 |
